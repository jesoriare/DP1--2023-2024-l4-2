...
import PartidaListAdmin from "./admin/partida/PartidaListAdmin";
import PartidaEditAdmin from "./admin/partida/PartidaEditAdmin";
import PartidaComponent from "./partidas/PartidaComponent";
import Reglas from "./reglas/reglas"
import PartidaListOwner from "./owner/partidas/PartidaListOwner"
import EstadisticasComponent from "./partidas/EstadisticasComponent";
    ...
    if (role === "ADMIN") {
      adminRoutes = (
        <>
          ...
          <Route path="/partidas/:id" exact={true} element={<PrivateRoute><PartidaEditAdmin /></PrivateRoute>} />
        </>)
    }
    if (role === "OWNER") {
      ownerRoutes = (
        <>
          ...
          <Route path="/partidas" element={<PartidaListOwner />} />
        </>)
    }
    if (role === "VET") {
      vetRoutes = (
  ...
  if (!jwt) {
    ...
    userRoutes = (
      <>
        ...
        <Route path="/login" element={<Login />} />
        <Route path="/partidagf/:id" element={<PartidaComponent 
        setNavVisible={setNavVisible}/>} />
        <Route path="/estadisticas" element={<EstadisticasComponent />} />
